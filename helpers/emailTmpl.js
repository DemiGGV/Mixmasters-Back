                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="left" valign="top"
                                        ...
                                        <div
                                            style="font-family:Arial, Helvetica, sans-serif; font-size:72px; color:#000000;">
                                            <i>Hello, ${user}!</i></div>
                                        ...
                                        <div><br>
                                            You can unsubscribe from the mailing list at any time by clicking here: <a href="http://">Unsubscribe</a>
                                        </div>
                                    </td>
                                </tr>
                            </table>
